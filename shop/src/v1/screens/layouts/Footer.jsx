                  ...
                  <div className="footer-infor">
                    ...
                    <div className="footer-address mb-4">
                      <p>549 Oak St.Crystal Lake, IL 60014</p>
                        ...
                        <Link className="flex gap-2 mt-2 items-center text-[15px]">GET DIRECTION <MdArrowOutward size={"23px"}/></Link> 
                    </div>
                    ...
                    <div className="footer-col-block">
                      ...
                      <div className="tf-collapse-content">
                        <div className="footer-menu-list space-y-2">
                          <Link to="about-us.html" className="footer-menu_item text-caption-1 block">About Us</Link>
                          <Link to="#" className="footer-menu_item text-caption-1 block">Our Stories</Link>
                          <Link to="#" className="footer-menu_item text-caption-1 block">Size Guide</Link>
                          <Link to="contact.html" className="footer-menu_item text-caption-1 block">Contact us</Link>
                          <Link to="#" className="footer-menu_item text-caption-1 block">Career</Link>
                          <Link to="my-account.html" className="footer-menu_item text-caption-1 block">My Account</Link>
                        </div>
                      </div>
                    </div>
                    <div className="footer-col-block">
                      ...
                      <div className="tf-collapse-content">
                        <div className="footer-menu-list space-y-2">
                          <Link to="#" className="footer-menu_item text-caption-1 block">Shipping</Link>
                          <Link to="#" className="footer-menu_item text-caption-1 block">Return & Refund</Link>
                          <Link to="#" className="footer-menu_item text-caption-1 block">Privacy Policy</Link>
                          <Link to="term-of-use.html" className="footer-menu_item text-caption-1 block">Terms & Conditions</Link>
                          <Link to="FAQs.html" className="footer-menu_item text-caption-1 block">Orders FAQs</Link>
                          <Link to="wish-list.html" className="footer-menu_item text-caption-1 block">My Wishlist</Link>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="footer-col-block">
                    ...
                    <div className="tf-collapse-content">
                      <div className="footer-newsletter">
                        <p className="text-caption-1 mb-4">Sign up for our newsletter and get 10% off your first purchase</p>
                        <form 
                        ...
                        <div className="tf-cart-checkbox mt-4 flex items-start gap-2">
                          ...
                          <label className="text-caption-1" htmlFor="footer-Form_agree">
                            By clicking subscribe, you agree to the <a className="fw-6 link underline" href="term-of-use.html">Terms of Service</a> and <a className="fw-6 link underline" href="#">Privacy Policy</a>.
                          </label>
                        </div>
                      </div>
                    </div>
