  ...
  return (
    <div className='w-full max-w-7xl mx-auto px-1'>
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 place-items-center gap-3'>
        {/* Card section */}
        {data.map((item, index) => (
          <div data-aos='fade-up' data-aos-delay={item.aosDelay} className='overflow-hidden' key={index}>
            <img src={item.image} alt={item.title} className='h-full object-cover rounded-md' />
            <div>
