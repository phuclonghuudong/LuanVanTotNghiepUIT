...
const Slide = () => {
  ...
  return (
    <div className='relative overflow-hidden min-h-[550px] sm:min-h-[550px] bg-gray-100 flex justify-center items-center duration-200'>
      {/* background pattern */}
      <div className='h-[700px] w-[600px] bg-[#fea928]/40 absolute -top-1/2 right-0 rounded-3xl rotate-45 z-1'>
      </div>
      {/* hero section */}
        ...
        <div className='px-5'>
          <div className='grid grid-cols-1 sm:grid-cols-2'>
              ...
              <div className='order-1 sm:order-2'>
                ...
                >
                  <img src={data.image} alt=""  className='w-[300px] h-[300px] sm:h-[450px] sm:w-[450px] sm:scale-125 lg:scale-110 object-contain mx-auto'/>
                </div>
              </div>
          </div>
        </div>
